...
/* Added for mobile-web development */
...
<head>
	...
	<meta name="thumbnail" content="https://almosthomeusa.steelbridge.io/wp-content/uploads/ahthumb.jpg" />
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <link rel="alternate" type="application/rss+xml" title="<?php bloginfo('name'); ?> RSS Feed" />
    <link rel="pingback" href="<?php bloginfo('pingback_url'); ?>" />
    <!-- <PageMap>
      <DataObject type="thumbnail">
        <Attribute name="src" value="https://www.almosthomeusa.com/wp-content/uploads/ahthumb.jpg"/>
...
<body<?php ct_body_id('top'); ?> <?php body_class(); ?>>
  ...
  <div id="wrap" <?php if( !is_home()) { echo 'class="marT30"'; } ?>>

    <div class="container main-container">
      <section class="sixteen columns content-area">
